...
<html><head><style>
  ...
  h1,h2,h3,h4 { color: var(--gold); margin-top: 1.2em; letter-spacing: -0.01em; }
  a { color: var(--ctp-blue); }
  code { background: var(--white-6); padding: 2px 6px; border-radius: 4px; font-family: ${FONT_MONO_STACK}; font-size: 0.9em; }
  pre { background: var(--white-4); padding: 12px; border-radius: 8px; overflow-x: auto; }
  pre code { background: none; padding: 0; }
  blockquote { border-left: 3px solid var(--gold); margin-left: 0; padding-left: 12px; color: rgba(255,255,255,0.5); }
  table { border-collapse: collapse; width: 100%; }
  th,td { border: 1px solid var(--white-10); padding: 6px 10px; text-align: left; }
  th { background: var(--white-4); color: var(--gold); }
  img { max-width: 100%; }
  hr { border: none; border-top: 1px solid var(--white-10); }
