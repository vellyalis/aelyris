...
const ICON_PATHS: Record<AgentStatus, string> = {
  ...
  thinking: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-1-4h2v2h-2v-2zm1-10c-2.21 0-4 1.79-4 4h2c0-1.1.9-2 2-2s2 .9 2 2-1.79 2-4 2v3h2v-1.47c1.74-.65 3-2.31 3-4.28 0-2.52-2.09-4.25-3-4.25z",
