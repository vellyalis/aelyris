...
function darkMoodSurfaces(tone: {
  ...
  return {
    ...
    "--material-panel-filter": "blur(16px) saturate(1.2) brightness(0.8) contrast(1.08)",
    "--terminal-shell-filter": "blur(16px) saturate(1.16) brightness(0.82) contrast(1.08)",
    ...
    "--dialog-surface": `linear-gradient(180deg, rgba(${tone.text}, 0.075), transparent 28%), linear-gradient(145deg, rgba(${tone.accent}, 0.055), transparent 50%), radial-gradient(ellipse at 50% -10%, rgba(${tone.text}, 0.04), transparent 48%), rgba(${tone.panelStrong}, 0.8)`,
    "--dialog-surface-blur": "blur(22px) saturate(1.18)",
...
function crystalMoodSurfaces(): MoodSurfaceCSS {
  return {
    ...
    "--material-panel-filter": "blur(24px) saturate(1.36) brightness(0.88) contrast(1.08)",
...
const MOOD_SURFACE_CSS: Record<MoodPresetId, MoodSurfaceCSS> = {
  ...
  "aether-sakura": {
    ...
    "--material-panel-filter": "blur(14px) saturate(1.18) brightness(1.02) contrast(1.02)",
