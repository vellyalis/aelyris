...
NEXT IMPLEMENTATION SLICE: `A5.4 per-PTY handles and short map-lock boundaries`.
A5.1-A5.3 are complete in the current focused sequence; do not widen A5.4 into
TaskGraph/LSP ownership changes.
