...
const OUT = join(ROOT, ".codex-auto", "quality", "renderer-transparency.json");
...
async function main() {
  ...
  try {
    ...
    const report = await page.evaluate(async () => window.__AELYRIS_RENDERER_HARNESS__.runTransparencyProof());
