...
4. `product-delivery-instructions.md` - **ACTIVE / AIO-49 Mission completion receipt**.
   ...
   AIO-49 is the sole repo-mutating frontier: expose restart-safe immutable completion
   readback through the existing TaskManager/SQLite packet authority without replaying
   settlement or creating a second receipt/event/packet owner.
...
R0..A9/A9.6r1 (repo complete) -> product delivery GMV-0..3/AIO-48 (complete) -> AIO-49 (active)`。A9 certification は
