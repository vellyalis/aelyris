...
- Current machine truth refreshed 2026-07-03 JST:
  `pnpm verify:quality-score` = `81/100` (`283/351`), grade `C`,
  `releaseCandidateReady=false`; `pnpm verify:goal:safe` has the required proof
  registry at `28/28` and is `blocked-by-external-gates`.
