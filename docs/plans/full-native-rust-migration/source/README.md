...
Status: **proposal / implementation-ready design package**  
...
1. [`AELYRIS_FULL_NATIVE_RUST_MIGRATION_MASTER_PLAN.md`](./AELYRIS_FULL_NATIVE_RUST_MIGRATION_MASTER_PLAN.md)
2. [`docs/adr/ADR-013_FULL_NATIVE_RUST_PRODUCT_SURFACE_DRAFT.md`](./docs/adr/ADR-013_FULL_NATIVE_RUST_PRODUCT_SURFACE_DRAFT.md)
3. [`docs/requirements/AELYRIS_NATIVE_UI_REQUIREMENTS.md`](./docs/requirements/AELYRIS_NATIVE_UI_REQUIREMENTS.md)
4. [`docs/specs/AELYRIS_NATIVE_UI_ARCHITECTURE.md`](./docs/specs/AELYRIS_NATIVE_UI_ARCHITECTURE.md)
5. [`docs/specs/AELYRIS_NATIVE_UI_FRAMEWORK_SPEC.md`](./docs/specs/AELYRIS_NATIVE_UI_FRAMEWORK_SPEC.md)
6. [`docs/specs/AELYRIS_NATIVE_EDITOR_SPEC.md`](./docs/specs/AELYRIS_NATIVE_EDITOR_SPEC.md)
7. [`docs/specs/AELYRIS_NATIVE_UI_MIGRATION_ROADMAP.md`](./docs/specs/AELYRIS_NATIVE_UI_MIGRATION_ROADMAP.md)
8. [`docs/specs/AELYRIS_NATIVE_UI_VERIFICATION_PLAN.md`](./docs/specs/AELYRIS_NATIVE_UI_VERIFICATION_PLAN.md)
9. [`docs/specs/AELYRIS_NATIVE_UI_TRACEABILITY.md`](./docs/specs/AELYRIS_NATIVE_UI_TRACEABILITY.md)
...
| Root work order | Codex `/goal` 等へ渡す実行入口 |
