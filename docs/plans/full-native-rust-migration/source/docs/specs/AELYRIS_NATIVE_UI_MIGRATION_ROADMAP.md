...
### NUI-0.1 — Adopt ADR-013

- add ADR-013
- mark ADR-001 superseded for primary surface, preserve history
- mark Terminal Core hybrid-primary decision superseded
- no runtime code
...
Map every `aelyris_native.rs` command to target crate/test/verifier。Set file-size/command ratchet。
