# ADR-013 — Full-Native Rust Product Surface

Status: draft / proposed  
Date: 2026-07-28 JST  
Supersedes: ADR-001 **for the primary product surface only**  
Also supersedes: `TERMINAL_CORE_DESIGN.md §3` hybrid-primary decision  
Preserves: ADR-002 through ADR-012 unless explicitly amended
