...
- The release goal is now native-first hybrid; see `docs/history/NATIVE_FIRST_HYBRID_PRODUCT_GOAL.md`.
- The older full-native Rust plan remains as a strict stretch audit in `docs/history/FULL_NATIVE_RUST_FINAL_GOAL.md`.
