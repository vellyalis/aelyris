...
This note validates `docs/history/PERFORMANCE_AUDIT_REPORT.md` against the current codebase. The Gemini report was useful as a lead, but several claims needed tightening against implementation reality.
