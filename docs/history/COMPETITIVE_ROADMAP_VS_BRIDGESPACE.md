# Competitive Roadmap — Quorum と BridgeSpace / tmux の比較メモ（historical）
...
**自分たちの強みで差別化する。** Quorum の特徴＝**壊れにくい・監査できる・決定的なAI開発ワークスペース** + **堅牢なターミナル持続性** + **深いエディタ(LSP+Vim+Diff)**。①監査では、この領域は BridgeSpace/tmux と比べても作り込みがある、という所見だった（claim ではなく監査メモ）。
