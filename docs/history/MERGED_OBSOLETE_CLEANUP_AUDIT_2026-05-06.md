...
- Longrun worker worktrees under `<codex-home>\longrun-worktrees`: none
...
- `node <codex-home>\codex-longrun-selftest.mjs`: passed after removing a leftover temp selftest directory from a failed cleanup attempt
