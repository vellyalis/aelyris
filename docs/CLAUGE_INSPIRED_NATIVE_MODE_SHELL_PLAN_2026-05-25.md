...
The native-first hybrid goal in `docs/NATIVE_FIRST_HYBRID_PRODUCT_GOAL.md` is now authoritative for release. The strict full-native audit remains useful as a stretch signal, but it no longer defines release completion.
