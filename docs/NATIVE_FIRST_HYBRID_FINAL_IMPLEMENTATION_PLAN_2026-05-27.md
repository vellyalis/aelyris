...
- Clauge source good parts are tracked in `docs/CLAUGE_SOURCE_AUDIT_GOOD_PARTS_2026-05-27.md`; the target is upper compatibility for Aether's AI-terminal domain, not broad REST/SQL/NoSQL/S3 feature sprawl.
