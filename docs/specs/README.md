...
root `product-delivery-instructions.md` のactive `AIO-45`であり、GMV-0..3とAIO-44を
completed foundationとして既存Mission plannerをMCP Goalへ接続するsole repo-mutating
