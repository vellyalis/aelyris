...
初版: 2026-06-13。Last reviewed: 2026-07-13 JST。現在は公開読者と実装者向けの spec index として維持する。
...
| [AELYRIS_VERIFIABLE_AGENT_WORK_OS_ROADMAP_2026-07-13.md](./AELYRIS_VERIFIABLE_AGENT_WORK_OS_ROADMAP_2026-07-13.md) | tracked product roadmap | 常時 Now/Next/Unlocks、A6.2v1設計checkpoint、既存A7 scopeを保持した有限なA7 Core Mission Loop、A8/A9 release gates、post-A9 Apex V1-V9の能力unlockとacceptanceを分離したロードマップ |
