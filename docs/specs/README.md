...
full-native Rust migration は high-priority queued program だが、active phase と
並行せず、root work order が所有する active audit-remediation frontier と measured A8 を変更しない。A7後の
