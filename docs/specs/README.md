...
root `product-delivery-instructions.md` のactive `AIO-46`であり、GMV-0..3とAIO-44/45を
completed foundationとしてexact current Mission continuityをMCPへ接続するsole repo-mutating
