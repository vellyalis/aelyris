...
初版: 2026-06-13。Last reviewed: 2026-07-03 JST。現在は公開読者と実装者向けの spec index として維持する。
...
`externalBlockedCount=27`; this remains an alpha/not-release-ready state because
...
| [WU_RT_1_CONTINUATION.md](./WU_RT_1_CONTINUATION.md) | continuation | セッションクリア後の再開用 handoff。現在の branch/dirty state、最新 artifact 値、RT-1 phase table、supply-chain / native input closeout、次に選ぶ right-rail / agent-team / command-evidence WU を短く固定 |
