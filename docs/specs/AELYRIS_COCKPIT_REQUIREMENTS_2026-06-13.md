...
Source: docs/requirements.md plus the Phase 0/1, UI Token Dial,
...
- **CHANGED — merge authority.** v1 forbade any AI from merging to `main`
  ...
  MCP_TOOL_SURFACE §3.5/§4.4, PHASE_0_1 §5, PLANNER_SPEC §2,
...
- **docs/requirements.md (North star + shared contract)** — "`merge-to-main`
