...
#[tauri::command]
pub fn cost_caps(manager: State<'_, CostManager>) -> CostCaps {
    manager.caps()
}

/// Update the caps and broadcast them so open surfaces re-render.
#[tauri::command]
pub fn cost_set_caps(app: AppHandle, manager: State<'_, CostManager>, caps: CostCaps) -> CostCaps {
...
#[tauri::command]
pub fn cost_can_spawn(manager: State<'_, CostManager>, usage: CostUsage) -> SpawnDecision {
