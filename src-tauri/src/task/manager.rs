...
use super::mission::{
    activation_from_accepted_plan, aggregate_cockpit_coverage, cockpit_settlement_coverage,
    decision_unix_ms, AcceptanceCoverageEntry, BlockedWorkPacket, CockpitTaskSettlementOutcome,
    ...
    COCKPIT_GOVERNANCE_POLICY_ID, COCKPIT_SETTLEMENT_PROOF_VERSION, COMPLETED_WORK_PACKET_SCHEMA,
...
mod tests {
    ...
    fn cockpit_settlement_accepts_owned_rework_history_beyond_one_direct_child() {
        ...
        let observation =
            cockpit_settlement::observe_cockpit_settlement_git(&activation, &evidence);
    ...
    fn cockpit_settlement_completion_atomically_readies_dependents() {
        ...
        let changed =
            cockpit_settlement::project_cockpit_settlement_completion(&mut graph, "root").unwrap();
