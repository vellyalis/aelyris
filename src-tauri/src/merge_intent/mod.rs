...
//! what lets the backend-owned review consumer approve only the stored intent:
//! the merge target can never be re-pointed after review (the P0-3 security property).
//!
