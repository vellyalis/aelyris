...
use crate::mux::graph::{LifecycleState, MuxGraph, PaneRecord, PtyBinding};
...
pub fn router(state: ApiState) -> Router {
    ...
    Router::new()
        ...
        .route("/mux/workspaces/:id/panes/:pane_id", delete(close_mux_pane))
        .route(
        ...
        .route("/mux/workspaces/:id/layout/rotate", post(rotate_mux_layout))
